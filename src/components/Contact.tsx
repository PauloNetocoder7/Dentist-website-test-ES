      ...
      <div className="container mx-auto px-8 lg:px-16 relative">
        <div className="grid lg:grid-cols-2 gap-20 items-stretch relative z-10">
          <div className="flex flex-col justify-center">
            <span className="text-sky-600 font-bold text-sm tracking-[0.2em] uppercase mb-4 block">Contáctanos</span>
            <h2 className="text-4xl font-bold text-slate-900 mb-6">Juntos por tu Salud Bucodental.</h2>
            <p className="text-slate-600 text-lg mb-12 max-w-md leading-relaxed">
              Estamos convenientemente ubicados para atenderle. Póngase en contacto con nosotros para programar su próxima visita o hacernos cualquier pregunta sobre nuestros tratamientos.
            </p>

            <div className="space-y-6">
              {[
                { icon: MapPin, title: 'Nuestra Ubicación', detail: 'Calle de la Salud 123, Ciudad de la Sonrisa' },
                { icon: Phone, title: 'Llámenos', detail: '(555) 123-4567' },
                { icon: Clock, title: 'Horario', detail: 'Lun - Jue: 8:00 - 17:00' }
              ].map((item, i) => (
          ...
          >
            <h3 className="text-2xl font-bold mb-8 text-sky-900">Solicitar Información</h3>
