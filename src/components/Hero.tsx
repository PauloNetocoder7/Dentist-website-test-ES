    ...
    <section className="relative min-h-[90vh] flex items-center pt-24 pb-20 overflow-hidden group">
      ...
      <div className="container mx-auto px-8 lg:px-16 relative z-10">
        <div className="max-w-2xl">
          ...
          >
            <span className="text-sky-600 font-bold text-sm tracking-[0.2em] uppercase mb-4 block">Cuidado Dental Compasivo</span>
            <h2 className="text-5xl lg:text-7xl font-bold text-slate-900 leading-tight mb-6">
              Excelencia en Odontología, <br/>
              <span className="text-sky-700 font-bold">Dedicada a tu Salud.</span>
            </h2>
            <p className="text-lg text-slate-600 mb-10 leading-relaxed max-w-lg font-medium">
              Ofrecemos servicios odontológicos generales, estéticos y quirúrgicos de alta calidad para la comunidad en un entorno cómodo y moderno.
            </p>
