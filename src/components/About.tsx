      ...
      <div className="container mx-auto px-8 lg:px-16">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <span className="text-sky-600 font-bold text-sm tracking-[0.2em] uppercase mb-4 block">Nuestro Compromiso</span>
            <h3 className="text-4xl lg:text-5xl font-bold text-slate-900 mb-8 leading-tight">
              Un Legado de Cuidado en el <br/> <span className="text-sky-700">Corazón de la Ciudad.</span>
            </h3>
            
            <p className="text-lg text-slate-600 mb-8 leading-relaxed">
              Al servicio de la comunidad durante más de dos décadas, DENTISTA Clínica & Estética combina tecnología de vanguardia con un enfoque personalizado para que cada visita sea cómoda.
            </p>
            ...
            <div className="pt-8 border-t border-slate-200">
              <p className="text-slate-500 italic text-lg leading-relaxed">
                "Nuestra clínica se basa en los mismos valores que nuestra comunidad: cercanía, integridad y confianza mutua."
              </p>
            </div>
          </motion.div>
        </div>
