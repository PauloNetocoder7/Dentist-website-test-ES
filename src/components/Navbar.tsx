      ...
      <div className="bg-sky-900 text-white py-2 px-8 hidden sm:block">
        <div className="max-w-7xl mx-auto flex justify-between items-center text-xs font-medium">
          <div className="flex gap-6">
            <span className="flex items-center gap-1.5 font-medium">📍 Calle de la Salud 123, Ciudad de la Sonrisa</span>
          ...
          <div className="flex gap-6 items-center">
            ...
            <span className="opacity-70 text-[10px] uppercase font-bold tracking-wider">Servicio de Urgencias Disponible</span>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="flex gap-1.5 mt-1 items-center">
                <img src="https://flagcdn.com/w40/es.png" alt="España" className="h-3 w-5 object-cover rounded-[1px] shadow-xs border border-slate-200/50" referrerPolicy="no-referrer" />
              </div>
            </div>
          </div>
